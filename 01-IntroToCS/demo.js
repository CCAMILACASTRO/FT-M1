...
console.log("Disyunción - XOR: ");

console.log("true XOR true: ", true ^ true);
console.log("true XOR false: ", true ^ false);
console.log("false XOR true: ", false ^ true);
console.log("false XOR false: ", false ^ false);

console.log("Conjunción - NOT: ");
